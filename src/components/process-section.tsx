...
export default function ProcessSection({ variant = "dark" }: { variant?: "dark" | "light" }) {
  const { t } = useI18n();
  return (
    <section id="processo" className={`w-full ${variant === 'dark' ? 'bg-black' : 'bg-white'} py-16 px-6`}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-white rounded-3xl border border-neutral-200 p-8 flex flex-col items-start shadow-[0_6px_24px_rgba(0,0,0,0.06)] min-h-[420px]">
            {/* Animação integrada */}
