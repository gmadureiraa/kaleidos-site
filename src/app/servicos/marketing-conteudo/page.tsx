              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                    ...
                    <p className="text-gray-600 text-sm">{locale==='en' ? 'Persuasive texts that turn visitors into customers, using advanced sales psychology techniques.' : 'Textos persuasivos que convertem visitantes em clientes, usando técnicas avançadas de psicologia de vendas.'}</p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                ...
                <div className="grid grid-cols-3 gap-6 pt-6">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-black mb-2">{locale==='en' ? KALEIDOS_METRICS.videosEditados_en : KALEIDOS_METRICS.videosEditados}</div>
                    <div className="text-sm text-gray-600">{locale==='en' ? 'Edited videos' : 'Vídeos editados'}</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-black mb-2">{locale==='en' ? KALEIDOS_METRICS.viewsReels_en : KALEIDOS_METRICS.viewsReels}</div>
                    <div className="text-sm text-gray-600">{locale==='en' ? 'Reels views' : 'Views nos reels'}</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-black mb-2">{locale==='en' ? KALEIDOS_METRICS.designsCriados_en : KALEIDOS_METRICS.designsCriados}</div>
